...
try:
    ...
    if not tesseract_path:
        raise FileNotFoundError("Tesseract OCR is not installed. Attempting manual installation...")

    # Set the Tesseract path
    pytesseract.pytesseract.tesseract_cmd = tesseract_path

except (ImportError, FileNotFoundError) as e:
    st.error("Tesseract OCR is missing. Running `startup.sh` to install it...")
    os.system("bash startup.sh")  # Run the startup script manually
    st.stop()
